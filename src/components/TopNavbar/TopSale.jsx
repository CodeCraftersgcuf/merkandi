...
const TopSale = () => {
    ...
    return (
        <>  
            <div className="top-bar w-full min-h-[90px] py-2 flex items-center bg-[#05006E]">
                <div className='w-full' style={top_sale}>
                    <div className='w-full flex items-center justify-between container text-white px-4 lg:mx-0 lg:px-24 py-2'>
                        ...
                        <div>
                            ...
                            <p className='text-center md-text-left '>Number of remaining packages</p>
                        </div>
                        <Link to='/register' className='hover:bg-[#c08f33] hover:text-white cursor-pointer text-white gap-2
