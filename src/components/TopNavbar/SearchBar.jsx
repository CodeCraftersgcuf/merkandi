...
const SearchBar = () => {
  ...
  return (
    <div className="container mx-auto px-4 lg:px-24 py-4 flex flex-col lg:flex-row items-center justify-between">
      {/* Top Row for Logo and Profile Login/Sign Up */}
      <div className="flex items-center justify-between w-full lg:w-fit">
        {/* Logo */}
        <div className="flex items-center md:mr-4 mt-3 w-[100px] lg:w-full">
          <Link to='/'>
            <img
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <h6 className="flex items-center gap-1 text-sm">
                <Link to="/login" className="text-[#299BCC]">login</Link> |{" "}
                <Link to="/login" className="text-red-500">Create Link new account</Link>
              </h6>
            </div>
          </div>
          <div>
      ...
      <div className="w-full flex items-center justify-center mt-3">
        <div className="flex items-center border border-gray-300 overflow-hidden  w-full lg:max-w-md xl:max-w-lg mr-4">
          <div className="relative">
            ...
            >
              <option value="products" className=''>Products</option>
              <option value="stockOffers" className=''>Stock offers</option>
              <option value="topOffers" className=''>Top offers</option>
            </select>
          </div>
