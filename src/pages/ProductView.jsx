            ...
            <div className="flex flex-wrap md:gap-2 lg:gap-0">
              ...
              <div className="product-detail md:w-[100%] px-4  lg:w-1/2">
                ...
                <div className="price-can py-4 flex flex-wrap gap-2 items-end">
                  ...
                  <span className="text-gray-400 pb-1 ">/piece</span>
                  <span className="text-green-500 pb-1 ">price excl. VAT</span>
                </div>
            ...
            <div className="border my-8 p-4">
              <div className="description-can">
                ...
                <div className="mt-8 flex flex-col gap-4 ">
                  <p>
                    Stock of WOMEN'S MEN'S CHILDREN'S clothing, shoes, underwear
                    and accessories and household items.
                  </p>

                  <p>General offer of all available brands.</p>

                  <p>
                    Price per unit or kg (starting from €0.90 per piece or 4.50
                    per KG)
                  </p>

                  <p>
                    Ideal product for OUTLETS and STREET VENDORS coming from the
                    past season.
                  </p>
                  ...
                  <p>
                    Small and large quantities sold (from 100 pieces to one
                    truck)
                  </p>
                  ...
                  <p>
                    Visit our 1,000 sqm showroom: - in person, in Italy - via
                    video link via smartphone.
                  </p>

                  <p>
                    Note: Brands may only be available for sale in specific
                    countries. Ask for all the information
                  </p>
              ...
              <div className="payemnts">
                ...
                <ul className="\">
                  <li className="flex items-center gap-4">
                    <i className="text-green-500 fa-solid fa-check"></i>Cash
                  </li>
                  <li className="flex items-center gap-4">
                    <i className="text-green-500 fa-solid fa-check"></i>VISA
                  </li>
                  <li className="flex items-center gap-4">
                  ...
                  <li className="flex items-center gap-4">
                    <i className="text-green-500 fa-solid fa-check"></i>American
                    Express
                  </li>
                  <li className="flex items-center gap-4">
                    <i className="text-green-500 fa-solid fa-check"></i>Maestro
                  </li>
                </ul>
              </div>
              <hr className="my-4" />
              <div className="delivery">
                <h1 className="my-4 font-bold text-xl">Delivery options</h1>
                <ul className="flex flex-wrap justify-between ">
                  ...
                  <li className="flex items-center gap-4">
                    <i className="text-green-500 fa-solid fa-check"></i>National
                    delivery
                  </li>
                  <li className="flex items-center gap-4">
                    <i className="text-green-500 fa-solid fa-check"></i>
              ...
              <div className="tags">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-6 py-2 border text-xs hover:bg-gray-300 cursor-pointer ">
                    Clothes
                  </span>
                  <span className="px-6 py-2 border text-xs hover:bg-gray-300 cursor-pointer ">
                    Kids
