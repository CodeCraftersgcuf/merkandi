      ...
      <>
        ...
        <div className=" px-[10px] py-8 md:px-[100px] bg-gray-100">
          <div className="container mx-auto max-w-[1280px] bg-white rounded-lg p-8">
            <h2 className="text-center text-3xl mb-5  tracking-widest">
              PAYMENT
            </h2>
              ...
              <table className="w-full border-collapse border  ">
                ...
                <tbody>
                  ...
                  <tr>
                    <td
                      colSpan="4"
                      className="px-4 py-2  border border-gray-300 text-right font-bold"
                    >
                      Total
                    </td>
            ...
            <div className="mt-5 text-right">
              <button
                ...
                onClick={() => setissDiscount(!isDiscount)}
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col items-center justify-between bg-gray-100 p-6 rounded-lg shadow-lg">
                  ...
                  <p className="text-sm text-center text-gray-600 mb-4  ">
                    The account number will be presented after you click this
                    option.
                  </p>
                  <button className="bg-orange-500 text-white px-6 py-2 rounded-md hover:bg-orange-400 w-full  ">
                    PAY
