      ...
      <div className="p-3 md:p-[50px] bg-gray-100">
        <div className="container max-w-[1280px] mx-auto grid md:grid-cols-12 gap-3 ">
                  ...
                  <div className="col-span-9 flex flex-wrap">
                    ...
                    <div className="w-full md:w-1/2 p-1   ">
                      ...
                      <div className="relative">
                        ...
                        >
                          {isPassword ? (
                            <i className="fa-solid fa-eye-slash text-gray-400 text-sm cursor-pointer"></i>
                          ) : (
                            <i className="fa-solid fa-eye text-gray-400 text-sm cursor-pointer"></i>
                          )}
                        </div>
                      </div>
                      {/* <div className='invalid-feedback block'>
                    ...
                    <div className="w-full p-1   ">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          name="invoice"
                          id="invoice"
                          onFocus={() => setIsinvoice(!isInvoice)}
          ...
          <div className="p-6 border bg-gray-50 md:col-span-4 order-1 md:order-2">
            ...
            <h1>
              <span className="text-2xl font-bold  ">EUR 223.20</span> +VAT / 1
              year
            </h1>
