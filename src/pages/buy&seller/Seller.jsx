  ...
  return (
    <>
      ...
      <section className="container max-w-[1280px] bg-white shadow-md -translate-y-4 mx-auto py-10 border">
        ...
        {/* Statistics Section */}
        <div className="px-8 bg-[#FFEBC7] py-8 mt-7 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            >
              <i
                className={`fa-solid ${stat.icon} text-5xl text-[#F29D00]`}
              ></i>
              <h1 className="text-2xl font-bold text-[#F29D00]  ">
                {stat.count}
              </h1>
        ...
        <div className="my-8">
          <h1 className="text-2xl font-bold text-center ">
            Discover the Benefits of Selling on Lot24
          </h1>
          <p className="text-xl text-center max-w-3xl mx-auto">
            At Merkandi, we understand that sellers' success in wholesale
            depends on access to the best business tools. That is why, we have
            created a platform for sellers that offers numerous benefits:
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 my-8 px-4">
            {[
              {
                icon: "fa-infinity",
                title: "Listing unlimited number of offers",
                description:
                  "We are offering you an option of listing unlimited number of offers, all with images and packing lists.",
              },
              {
                icon: "fa-globe",
                title: "Your company listed in the international catalogue",
                description:
                  "We will add your company to the international catalogue of wholesalers and manufacturers.",
              },
              {
                icon: "fa-comments",
                title: "Real-time buyer feedback",
                description:
                  "Access feedback from buyers to enhance your offerings and build long-term business relationships.",
              },
              {
                icon: "fa-cogs",
                title: "Advanced seller tools",
                description:
                  "Manage your listings, track inquiries, and optimize your wholesale strategy with our easy-to-use dashboard.",
              },
              {
                icon: "fa-envelope",
                title: "Daily updates",
                description:
                  "Stay updated with new buyer requests and trends to maximize your sales potential.",
              },
              {
                icon: "fa-map-marker-alt",
                title: "Targeted marketing",
                description:
                  "Target specific regions or industries to ensure your stock reaches the right buyers effectively.",
              },
            ].map((benefit, index) => (
              <div key={index} className="flex items-start gap-4 ">
                ...
                ></i>
                <div>
                  <h2 className="font-bold text-md  ">{benefit.title}</h2>
