  ...
  return (
    <>
      ...
      <section className="container  max-w-[1280px] bg-white shadow-md -translate-y-4 mx-auto py-10 border">
        ...
        {/* Statistics Section */}
        <div className="px-8 bg-[#FFEBC7] py-8 mt-7 flex flex-wrap justify-evenly items-start gap-6">
          {[
            ...
            <div
              key={index}
              className="flex flex-col items-center text-center gap-3 max-w-[62px] md:max-w-fit"
            >
              <i
                className={`fa-solid ${stat.icon} text-4xl md:text-5xl text-[#F29D00]`}
              ></i>
        ...
        <div className="my-8">
          <h1 className="text-2xl font-bold text-center  ">
            Discover the World of Wholesale Trade with Lot24
          </h1>
          <p className="text-xl text-center max-w-3xl mx-auto ">
            At Lot24, we know that success in wholesale requires access to the
            best offers and reliable business partners. That is why we have
            created a platform for buyers that offers numerous benefits:
          </p>
