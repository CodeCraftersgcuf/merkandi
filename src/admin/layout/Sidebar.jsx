        ...
        <div className="bg-white border-r min-h-screen p-4">
            ...
            <div className="mt-6">
                ...
                <nav className="flex flex-col gap-3">
                    <Link to="/dashboard" className="flex items-center gap-3 text-gray-500 hover:text-black">
                        <i className="fa-solid fa-gauge"></i>
                        Dashboard
                    </Link>
                    <Link to="/products" className="flex items-center gap-3 text-gray-500 hover:text-black">
                        <i className="fa-brands fa-product-hunt"></i>
                        Products
                    </Link>
                    <Link to="/orders" className="flex items-center gap-3 text-gray-500 hover:text-black">
